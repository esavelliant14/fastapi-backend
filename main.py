                                ...
                                if input_policer == row.old_input_policer and output_policer == row.old_output_policer:
                                    ...
                                    conn.execute(
                                        ...
                                        """),
                                        {
                                            ...
                                            "agent": "backend",
                                            "details": f"Rollback for client {row.description} interface={row.interface} unit={row.unit_interface} success from BOD bandwidth(up/down)={row.bod_input_policer}/{row.bod_output_policer} to old bandwidth={row.old_input_policer}/{row.old_output_policer}, status change with Inactive",
